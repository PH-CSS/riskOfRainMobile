...
import { Add } from '../../components/Icons/index';
          ...
          options={{
            ...
            tabBarIcon: ({ focused }) => (
              <View
                ...
                <IconCase className="size-12 bg-darkgray" Icon={<Add />} />
          ...
          options={{
            ...
            tabBarIcon: ({ focused }) => (
              <View
                ...
                style={{ transform: [{ translateY: -13 }] }}>
                <IconCase data-focus={focused} className={`size-12 ${focused ?  "bg-primary01" : "bg-darkgray" }`} Icon={<Add  color={focused ? "#1A1A1A" : "#DBB33A"}/>} />
                <Text className="w-full text-nowrap font-ChakraPetch_light text-sm leading-3  text-white">
                  Perfil
                </Text>
              </View>
